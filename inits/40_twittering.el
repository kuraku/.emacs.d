;; -*- emacs-list -*-
;; @@ Twittering-mode
;; Time-stamp: <2018-08-31 16:34 masuda>
...
(setq twittering-timer-interval 900)   ; Update your timeline each <- seconds (15 minutes)
...
;;		  "_littlegray/RadioDJ" 
		  ...
		  ;;"_littlegray/LL"
;;		  "_littlegray/Ukulele"
		  ":search/#tama954 AND -kamatomo_HASH AND -MDSsan AND -indonoringo/"
;;		  ":search/(groovelinez OR piston2438 OR #glz OR #gl) AND -piston2438_bot/"
		  ;;"$r(groovelinez)"
		  ;;":search/#jwave AND -MDSsan/"
		  ":search/(#ij954 OR #so954 OR #ar954) AND -MDSsan AND -indonoringo/"
		  ;;":search/#bayfm AND -MDSsan/"
;;		  ":search/#bayline AND -MDSsan/"
;;		  ":search/ウクレレ/"
		  ;;":search/#musicsalad/"
