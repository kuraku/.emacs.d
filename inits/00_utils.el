;; -*- emacs-lisp -*-
;; @@ Utils
;; Time-stamp: <2018-03-22 16:43 akira.masuda>
...
;;
(defun ma:reuse-replce-tsv (start end)
  "リユース tsvファイルをこぴぺで持ってきたときの変換"
  (interactive "r")
  (save-excursion
    (save-restriction
	  ...
	  ;;
	  (goto-char (point-min))
      (while (re-search-forward "\\.tsv:" nil t)
        (replace-match ".tsv: "))
	  ;;
      (goto-char (point-min))
